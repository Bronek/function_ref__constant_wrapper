...
However, a similar optimization opportunity can be also created without the use of `nontype`. A function wrapper construtor might
...
* direct call defined in `operator()`, as stated in [@P2781] _and_
...
* Consider optimizing other function wrappers for such a stateless constructor parameter
